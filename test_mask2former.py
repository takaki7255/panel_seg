"""
Test/Evaluation script for Mask2Former Panel Instance Segmentation

Usage:
    python test_mask2former.py \
        --model ./panel_models/mask2former/mask2former_best.pt \
        --root ./frame_dataset/test100_instance \
        --save-preds \
        --output ./results/mask2former
"""
...
# Dataset
# ============================================================================
class PanelInstanceTestDataset(Dataset):
    """Test dataset for instance segmentation"""
...
def parse_args():
    parser = argparse.ArgumentParser(description='Test Mask2Former for Panel Segmentation')
    ...
    parser.add_argument('--output', type=str, default='./results/mask2former')
...
def main():
    ...
    dataset = PanelInstanceTestDataset(args.root, img_size=img_size)
    ...
    print("\n" + "=" * 60)
    print("Mask2Former Evaluation Results")
    print("=" * 60)
